...
mixin _$UserViewModel on _UserViewModelBase, Store {
  ...
  final _$removeUserPlaylistAsyncAction =
      AsyncAction('_UserViewModelBase.removeUserPlaylist');

  @override
  Future<void> removeUserPlaylist({@required Playlist playlist}) {
    return _$removeUserPlaylistAsyncAction
        .run(() => super.removeUserPlaylist(playlist: playlist));
  }
